...
public class ErrorMessages {
    ...
    public static final String MISSING_TASK_DESCRIPTION = "Missing task description!";
    ...
    public static final String END_DATE_EARLIER = "Your End Date should be later than your Start Date.";
