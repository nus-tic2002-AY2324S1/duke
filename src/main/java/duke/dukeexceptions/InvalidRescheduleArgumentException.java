...
/**
 * The InvalidRescheduleArgumentException class is used to handle invalid rescheduling arguments in Duke.
 * This exception is thrown when the provided reschedule format is incorrect.
 */
public class InvalidRescheduleArgumentException extends DukeException {
   ...
   * The format should be "<reschedule + Task index + yyyy-MM-dd HH:mm>".
   */
