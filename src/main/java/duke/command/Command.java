...
public abstract class Command {
     ...
     * @throws InvalidArgumentException If the Matcher does not match the pattern, an exception is thrown with an error message.
     */
     ...
     * @param command The Command associated with the pattern being checked.
     * @param addOn Additional information to be included in the error message (can be empty).
     * @throws InvalidArgumentException If the Matcher does not match the time pattern, an exception is thrown with an error message.
     */
