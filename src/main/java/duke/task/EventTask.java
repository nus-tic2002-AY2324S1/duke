...
public class EventTask extends Task {
     ...
     * @param taskTo    The end date and time of the event task.
     */
    public EventTask(String taskName, boolean completed, LocalDateTime taskFrom,
                     LocalDateTime taskTo) {
    ...
    /**
     * Checks if a given date matches either the start date or the end date of the task.
     *
     * @param checkedDate The date to check against the task's start and end dates.
     * @return true if the checked date matches either the start date or the end date of the task.
     */
    @Override
    ...
    public String toFile() {
        ...
        return super.toFile() + " | " + taskFrom.toString().replace("T", " ") + " | "
                + taskTo.toString().replace("T", " ");
    }
