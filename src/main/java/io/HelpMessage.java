    ...
    public static void printHelpMessage() {
        System.out.println(
                SPACES + "    ❉⊱•  Welcome to Craby's help page! •⊰❉" + System.lineSeparator() +
                        ...
                        SPACES + "12. switch - switch to another list" + System.lineSeparator() +
                        SPACES + "    ╰┈➤after that CarbY will ask you to enter the name of the list" + System.lineSeparator() +

                        SPACES + "13. help - show the list of commands" + System.lineSeparator() +
                        SPACES + "    ╰┈➤e.g. help" + System.lineSeparator() +

                        SPACES + "14. bye - exit the program" + System.lineSeparator() +
