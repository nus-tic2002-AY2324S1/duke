...
public class ErrorMessages {
    ...
    public static final String INVALID_DEADLINE_COMMAND_FORMAT = "Ensure you follow the correct format for Deadlines. Your date should also be in this format: YYYY-MM-DD.";
    public static final String INVALID_EVENT_COMMAND_FORMAT = "Ensure you follow the correct format for Events. Both dates should also be in this format: YYYY-MM-DD.";
    ...
    public static final String TRAILING_LETTERS_BEHIND_FROM = "Ensure you have no trailing letters behind /from.";
    public static final String TRAILING_LETTERS_BEHIND_TO = "Ensure you have no trailing letters behind /to.";
    public static final String ERROR_END_DATE_BEFORE_START_DATE = "Your End Date should be later than your Start Date.";
    public static final String INVALID_USER_INPUT = "Oops! Invalid input, look at the manual to see the accepted inputs!";
}
