...
public class FindCommand extends Command{
    ...
    public FindCommand(String line) throws DukeException{
        if (line.split(" ").length>2) throw new DukeException("Please provide only one keyword at a time!");
        this.keyword = line.split(" ")[1].toLowerCase();
    }    
    /**
     * {@inheritDoc}
     * 
     * This implementation of {@code execute} finds all tasks
     * with the given {@code keyword} attribute and prints.
     * 
