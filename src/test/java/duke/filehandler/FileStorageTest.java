...
public class FileStorageTest {
    ...
    public void testStore() throws IOException {
        ...
        taskList.add(new EventTask("Test Event 1", true, LocalDate.now().atStartOfDay(),
        ...
        assertEquals(
                "D | 0 | Test Deadline 1 | " + LocalDate.now().atStartOfDay().toString().replace("T", " "),
                lines.get(1));
        assertEquals(
                "E | 1 | Test Event 1 | " + LocalDate.now().atStartOfDay().toString().replace("T", " ")
                        + " | " + LocalDate.now().atStartOfDay().toString().replace("T", " "), lines.get(2));
    }
