...
public class MarkAsCompletedCommandTest {
    ...
    void testMarkingIncompleteTask() {
        ...
        String expectedOutput =
                "That's some progress! I've marked this task as done:" + System.lineSeparator()
                        + "   " + taskList.get(0).toString()
                        + System.lineSeparator() + MessageDisplay.LINE_BREAK
    ...
    void testMarkingCompletedTask() {
        ...
        String expectedOutput = task.getTaskName() + " is already marked!" + System.lineSeparator()
