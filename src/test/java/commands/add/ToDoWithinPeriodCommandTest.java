...
public class ToDoWithinPeriodCommandTest {
    ...
    public void ToDoWithinPeriodConstructorTest() throws DukeException {
        ...
        // Working Test Case
        ToDoWithinPeriodCommand t =
                new ToDoWithinPeriodCommand("todo colllect certificate /between 2023-10-08 /and 2023-10-10");

        // Test Case 1: Missing Task Description
        exception = assertThrows(DukeException.class,
                () -> new ToDoWithinPeriodCommand("todo /between 2023 /and 2023-10-20"));
        ...
        exception = assertThrows(DukeException.class, () -> new ToDoWithinPeriodCommand(
                "todo collect certificate /between 2023-10-08 /and 2023-10-07"));
